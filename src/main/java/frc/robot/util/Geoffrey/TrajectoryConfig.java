...
public class TrajectoryConfig {
    ...
    public static TrajectoryConfig getPassingConfig() {
        ...
        config.DVX_COEFFS = new double[]{
            -0.1779035659344022, -0.04328385029259351, 0.7363934104772497, -0.013401210967835423, 0.14866841663923833, -0.6183758086494308, -0.00023715163020891078, 0.006482624550329427, -0.04818115086231098, 0.13956477423568728
        };
        config.DVY_COEFFS = new double[]{
            0.016181735656721236, -0.011739688041672882, 0.0030192687547994416, -0.0024250197964459817, 0.0021606067912207927, 0.005920547896335245, -1.4916565228371287e-06, 0.0003994230814203738, -0.0014056025691093217, 0.00028463151742891827
        };
        return config;
    }
