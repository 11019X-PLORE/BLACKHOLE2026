...
public class TrajectoryConfig {
  ...
  public static TrajectoryConfig getPassingConfig() {
    ...
    config.DVX_COEFFS =
        new double[] {
          -0.048256378229883934, 0.004645128298960892, 0.13747762243110465, -0.00040371047867558116, 0.02484219323204584, -0.06742718947666232, -8.878625075056483e-05, 0.0010411682865853209, -0.0053796383747517435, 0.010493765902012911
        };
    config.DVY_COEFFS =
        new double[] {
          0.002882918553756983, -0.005400324795804963, 0.028904765361434576, -0.0006073784724201789, 0.0025587899416334324, 0.002487259134709766, -3.407548742215272e-05, 0.00031739275665163447, -0.0009985960449592633, 0.0008698790342732325
        };
    return config;
  }
}
