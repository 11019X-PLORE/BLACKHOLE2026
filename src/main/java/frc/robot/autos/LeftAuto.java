...
public class LeftAuto extends SequentialCommandGroup {
  public LeftAuto(
    ...
    addCommands(
        ...
        Commands.parallel(generatePath("L1"), superstructure.setGoal(SuperstructureState.INTAKE)),
        generatePath("L2"),
        ...
        Commands.parallel(generatePath("L3"), superstructure.setGoal(SuperstructureState.INTAKE)));
  }
