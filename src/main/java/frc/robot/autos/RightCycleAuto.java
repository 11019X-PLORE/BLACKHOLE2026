...
public class RightCycleAuto extends SequentialCommandGroup {
  public RightCycleAuto(
    ...
    addCommands(
        ...
        Commands.parallel(generatePath("R4"), superstructure.setGoal(SuperstructureState.INTAKE)));
  }
