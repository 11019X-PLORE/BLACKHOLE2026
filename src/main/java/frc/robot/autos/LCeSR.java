...
public class LCeSR extends SequentialCommandGroup {
  public LCeSR(RobotContainer c, Supplier<Boolean> isRightSide) {
    Arm arm = c.arm;
    ...
    addCommands(
        ...
        drive.resetOdomToPath("LCeS"),
        Commands.deadline(
            drive.generatePath("LCeS"),
