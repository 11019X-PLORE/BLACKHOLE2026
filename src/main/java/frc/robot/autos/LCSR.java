...
public class LCSR extends SequentialCommandGroup {
  public LCSR(RobotContainer c, Supplier<Boolean> isRightSide) {
    Arm arm = c.arm;
    ...
    addCommands(
        ...
        drive.resetOdomToPath("LCS"),
        Commands.deadline(
            drive.generatePath("LCS"),
